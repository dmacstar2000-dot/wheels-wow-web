  ...
  return (
    <div>
      ...
      <section className="relative h-[60vh] my-16 overflow-hidden">
        <img src={g5} alt="AE86 against Southern Alps" loading="lazy" width={1280} height={896} className="w-full h-full object-cover" />
      </section>

      <section className="container-x pb-24 grid md:grid-cols-3 gap-8">
        {[
          { t: "Local", d: "From Whangarei to Bluff. We know the spots, we know the corners." },
          { t: "Fast", d: "Same-day socials, full edits in 7 days. No waiting weeks for your hero shot." },
          { t: "In it", d: "We don't just photograph the scene — we're part of it. You'll see us at the next round." },
        ].map((b) => (
          <div key={b.t} className="border-l-2 border-primary pl-6">
